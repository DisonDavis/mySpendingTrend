...
const SpendingEntry = () => {
  ...
  const { addNewTransaction, setInitialTransaction } = TransactionConsumer()
  ...
  const validateForm = () => {
    ...
    if (!reason || reason === '')
      newErrors.reason = 'Please enter the reason for the spending'
    if (!category || category === '')
      newErrors.category = 'Please enter spending category'
    return newErrors
  }
